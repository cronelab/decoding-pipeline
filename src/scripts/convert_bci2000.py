...
Converts BCI2000 datfiles to H5EEG format
...
def convert_dat( datfiles, h5filename = None, relabelcsv = None, overwrite = False, add_everything = False, no_dc = False ):
    ...
    datfiles = [ bcistream( filename ) for filename in datfiles ]
...
# Given a list of bcistreams, use this to convert to an hdf5 file.
...
if __name__=='__main__':
    ...
    parser = argparse.ArgumentParser( description = 'Convert BCI2000 dat to H5EEG.' )
    parser.add_argument( 'filename', help = 'BCI2000 Datfile Filename(s)', nargs = '+' )
    parser.add_argument( '-o', '--output', help = 'H5EEG Output Filename' )
    ...
    h5file = convert_dat( args.filename, h5filename = args.output,
