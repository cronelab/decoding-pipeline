...
# decoding_pipeline documentation build
...
from decoding_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "decoding_pipeline"
author = "Kedro"
...
htmlhelp_basename = "decoding_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "decoding_pipeline.tex",
        "decoding_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "decoding_pipeline",
        "Project decoding_pipeline codebase.",
        "Data-Science",
    )
]
